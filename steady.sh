#!/bin/bash
# =====================================================================================================
# Copyright (C) steady.sh v1.2 2016 iicc (@kamranya)
# =====================================================================================================
...
VOLUNTARYCHECK=0
I=1
BOT=telek  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo ""
echo -e "\033[38;5;208m @kamranya    :)      @cruel_channel \033[0;00m"
echo -e "\033[38;5;208m @kamranya    :)      @cruel_channel \033[0;00m"
echo -e "\033[38;5;208m @kamranya    :)      @cruel_channel \033[0;00m"
echo -e "\033[38;5;208m @kamranya    :)      @cruel_channel \033[0;00m"
echo -e "\033[38;5;208m @kamranya    :)      @cruel_channel \033[0;00m"
